# Can You Retire at 35 with $500k? A Lean FIRE Reality Check
...
The [4% rule was designed for 30-year retirements](/blog/calculating-fire-number). At 35, you need your money to last **55+ years** — nearly double what the Trinity Study tested. That's a serious problem.
...
To dig deeper into the math, check out [how to calculate your personal FIRE number](/blog/calculating-fire-number), explore [Lean FIRE](/blog/what-is-LEAN-FIRE) if you want a more aggressive savings path, or read about [Coast FIRE](/blog/what-is-Coast-FIRE) as a stepping stone to full financial independence.
