(() => {
    ...
    function drawChart(canvas, projection, fireNumber) {
        ...
        grad.addColorStop(0, getComputedStyle(document.documentElement)
            .getPropertyValue('--accent-color').trim() || '#7A4E00');
        ...
        areaGrad.addColorStop(0, 'rgba(var(--accent-rgb, 122, 78, 0), 0.18)');
        areaGrad.addColorStop(1, 'rgba(var(--accent-rgb, 122, 78, 0), 0)');
